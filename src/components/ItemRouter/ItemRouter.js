  ...
  return (
    ...
    style={{ backgroundImage: `url(${Image})` }} >
      ...
      <div id="info"
        ...
        The cost of this item in stores is {data.cost}.
        If applicable, the Pokemon who can be found holding this in the wild are: {data.held_by_pokemon}. 
        If applicable, the power of the move Fling when used with this item is: {data.fling_power}, and the effect is {data.fling_effect}.
        ...
        The version that this item is held in by the Pokémon is {data.version}.
